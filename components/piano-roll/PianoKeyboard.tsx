...
export function PianoKeyboard({ midiRange, rowHeight = 22 }: { midiRange: number[]; rowHeight?: number }) {
  return (
    <div className="w-16 shrink-0 border-r border-[#333333] bg-[#181818]" aria-hidden>
      {midiRange.map((midi) => {
        ...
        return (
          <div
            key={midi}
            className={`flex items-center justify-end border-b border-[#292929] pr-2 text-[10px] ${
